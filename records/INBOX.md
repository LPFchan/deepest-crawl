...
Ephemeral scratch disk for untriaged capture. Not a backlog, roadmap, or project
digest.
...
- Report counts or clusters of held/noisy/discarded items instead of
  summarizing every item.
...
Once an item has been reflected into `SPEC.md`, `STATUS.md`, `PLANS.md`,
`research/`, `decisions/`, a committed `LOG-*`, `upstream-intake/`, or a
deliberate discard/hold note, remove the entry.
